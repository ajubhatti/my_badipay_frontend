          ...
          <Grid container spacing={2}>
            <Grid item lg={3} md={6} xs={12}>
              <ul className="list-unstyled feature-list">
                ...
                <li>
                  <span>
                    <img src="./assets/images/home.png" className="img-fluid" />
                  </span>
                  <div>
                    <h4>Service title</h4>
            ...
            <Grid item lg={3} md={6} xs={12}>
              <ul className="list-unstyled feature-list">
                <li>
                  <span>
                    <img src="./assets/images/idea.png" className="img-fluid" />
                  </span>
                  <div>
                    <h4>Service title</h4>
            ...
            <Grid item lg={3} md={6} xs={12}>
              <ul className="list-unstyled feature-list">
                <li>
                  <span>
                    <img
                      src="./assets/images/gas-cylinder.png"
                      className="img-fluid"
                    />
                  </span>
                  <div>
            ...
            <Grid item lg={3} md={6} xs={12}>
              <ul className="list-unstyled feature-list">
                ...
                <li>
                  <span>
                    <img
                      src="./assets/images/investing.png"
                      className="img-fluid"
                    />
                  </span>
                  <div>
